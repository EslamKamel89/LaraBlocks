    ...
    <form wire:submit.prevent="submit" class="space-y-5">
        ...
        <div class="flex flex-wrap gap-2 pt-2">
            ...
            <button
                ...
                class="inline-flex items-center justify-center rounded-lg border border-indigo-200 bg-white px-4 py-2 text-sm font-semibold text-indigo-700
                       hover:bg-indigo-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2">
